      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-neutral-600">
            Dodaj instrukcję laboratoryjną oraz wyniki pomiarów. Sprawko
            przygotuje obliczenia, wykresy, analizę i dokument gotowy do dalszej
            edycji.
          </p>
        ...
        <div className="mt-24 grid gap-4 border-t border-neutral-200 pt-8 sm:grid-cols-3">
          <div>
            <div className="font-mono text-xs text-neutral-400">01 / DANE</div>
            <h2 className="mt-3 font-medium text-neutral-900">Dodaj pomiary</h2>
          ...
          <div>
            ...
            <h2 className="mt-3 font-medium text-neutral-900">Przetwarzanie</h2>
            <p className="mt-2 text-sm leading-6 text-neutral-500">
